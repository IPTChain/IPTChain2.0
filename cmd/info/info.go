...
func infoAction(c *cli.Context) (err error) {
	...
	var output [][]byte
	if height != -1 {
		resp, err = rpc.Call(Address(), "getblock", 0, []interface{}{height})
		if err != nil {
	...
	if c.String("blockhash") != "" {
		resp, err = rpc.Call(Address(), "getblock", 0, []interface{}{blockhash})
		if err != nil {
			fmt.Fprintln(os.Stderr, err)
			return err
		}
	...
	if bestblockhash {
		resp, err = rpc.Call(Address(), "getbestblockhash", 0, []interface{}{})
		if err != nil {
			fmt.Fprintln(os.Stderr, err)
			return err
		}
	...
	if blockcount {
		resp, err = rpc.Call(Address(), "getblockcount", 0, []interface{}{})
		if err != nil {
			fmt.Fprintln(os.Stderr, err)
			return err
		}
	...
	if connections {
		resp, err = rpc.Call(Address(), "getconnectioncount", 0, []interface{}{})
		if err != nil {
			fmt.Fprintln(os.Stderr, err)
			return err
		}
	...
	if neighbor {
		resp, err := rpc.Call(Address(), "getneighbor", 0, []interface{}{})
		if err != nil {
			fmt.Fprintln(os.Stderr, err)
			return err
		}
	...
	if state {
		resp, err := rpc.Call(Address(), "getnodestate", 0, []interface{}{})
		if err != nil {
			fmt.Fprintln(os.Stderr, err)
			return err
		}
	...
	if version {
		resp, err = rpc.Call(Address(), "getversion", 0, []interface{}{})
		if err != nil {
			fmt.Fprintln(os.Stderr, err)
			return err
		}
